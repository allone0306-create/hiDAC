...
export const casesData: CaseItem[] = [
  ...
  { 
    ...
    solution: '🛏️ 推窗见山的疗愈栖居：大堂对称布局，深胡桃木格栅与山水屏风相衬；客房以浅木色与低饱和灰为基调，搭配大面积落地窗将山林云雾引入室内，无主灯暖灯带营造出极致舒适的慢调安神氛围。'
  },
  { 
    id: 9, 
    slug: 'jianjia-home',
  ...
  },
  {
    ...
    challenge: '🏛️ 公共大堂挑空声学痛点：如何在18米挑高、超大体量空腔的公共大堂内，既维持东方空间含蓄与通透，又有效控制声波混响并保障气流冷热循环？',
    solution: '🛏️ 客房与园林内外共生：客房背景墙以简化中式花窗线条为元素，结合温润皮革与亚麻，无主灯温润柔和；外部以廊亭、白砂造景移步异景，让建筑成为连接传统园林意境与当代舒适的完美载体。'
  },
  {
    id: 14,
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-4">
            {brandPartners.map((brand) => (
              ...
              >
                ...
                <span className="text-[8px] tracking-wider text-white/25 font-mono uppercase block mt-1">合伙单位</span>
              </div>
            ))}
          </div>
        </section>
              ...
              <div className="w-full md:w-1/2 p-6 md:p-10 overflow-y-auto space-y-6 flex flex-col justify-between">
                <div className="space-y-6">
                  ...
                  <div className="space-y-4 pt-2 text-xs text-white/50 leading-relaxed font-light">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-1.5 text-[10px] font-mono text-[#c5a059] font-bold uppercase">
                        <Compass size={12} /> 达成方案 (Resolution)
                      </div>
